...
#ifndef MYNAME
#ifdef HAVE_XCACHE
#define MYNAME "xcache_client"
#elif HAVE_LIBMEMCACHED
#define MYNAME "ccache_remote"
#else
...
//xcache.c
int xcache_init(char *conf);
int xcache_raw_set(const char *key, const char *data,size_t len);
int xcache_set(const char *key,const char *obj,const char *stderr,const char *dia,const char *dep,size_t obj_len,size_t stderr_len,size_t dia_len,size_t dep_len);
void *xcache_raw_get(const char *key, char **data, size_t *size);
void *xcache_get(const char *key,char **obj,char **stderr,char **dia,char **dep,size_t *obj_len,size_t *stderr_len,size_t *dia_len,size_t *dep_len);
void xcache_free(void *blob);
int xcache_release(void);

typedef int (*RemoteInit)(char *conf);
typedef int (*RemoteRawSet)(const char *key, const char *data, size_t len);
typedef int (*RemoteSet)(const char *key, const char *obj, const char *stderr, const char *dia, const char *dep, size_t obj_len, size_t stderr_len, size_t dia_len, size_t dep_len);

typedef void *(*RemoteRawGet)(const char *key, char **data,size_t *size);

typedef void *(*RemoteGet)(const char *key, char **obj, char **stderr, char **dia, char **dep, size_t *obj_len, size_t *stderr_len, size_t *dia_len, size_t *dep_len);

typedef void (*RemoteFree)(void *blob);
typedef int (*RemoteRelease)(void);
